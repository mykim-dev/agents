...
import { Flower2, Leaf, Sun, Snowflake, ArrowLeft, Minimize2, Newspaper,FileArchive, SlidersHorizontal, HardDriveDownload, CircleCheck, ChevronDown, Terminal, PenLine, Expand } from 'lucide-react'
		...
		<div className="layout-dashboard">
			...
			<main>
				<div className="dashboard-wrap">
					...
					<div className={`dashboard-contents ${isDetailCollapsed ? 'is-detail-collapsed' : ''}`}>
									...
									<dd>
										<div className="chat-message-group">
											<p className="chat-message message-text">
												요즘IT 8월 인기 콘텐츠를 확인하고 9월 콘텐츠 기획을 위한 분석 보고서를 작성해 줘
